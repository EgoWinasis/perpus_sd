...
( 1, 'BK01001', 1, 1, '132-123-234-231', 'CARA MUDAH BELAJAR PEMROGRAMAN C++', 'INFORMATIKA BANDUNG', 'BUDI RAHARJO ', '2012', 23, '2019-11-23 11:49:57');
...
INSERT INTO `tbl_siswa` (`id_siswa`, `nis`, `nama`, `tempat_lahir`, `tgl_lahir`,`kelas`, `jenkel`, `alamat`, `tgl_bergabung`) VALUES
(1, '21041003', 'Ego Winasis',  'Tegal', '2000-08-08','5', 'Laki-Laki', 'Desa Kaladawa', '2023-03-10');
...
INSERT INTO `tbl_pinjam` (`id_pinjam`, `pinjam_id`, `anggota_id`, `kode_buku`, `status`, `tgl_pinjam`, `lama_pinjam`, `tgl_balik`, `tgl_kembali`) VALUES
