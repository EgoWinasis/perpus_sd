...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 24 Mar 2023 pada 02.18
...
INSERT INTO `tbl_alat` (`id_alat`, `kode_alat`, `id_kategori`, `nama_alat`, `jumlah`, `tgl_masuk`) VALUES
(8, 'AP01005', 1, 'KIT Bentang Alam', 1, '2023-03-18 09:20:34'),
(9, 'AP01008', 1, 'KIT Bentang Alam', 1, '2023-03-20 22:13:59'),
(10, 'AP01007', 1, 'KIT Gejala Alam', 1, '2023-03-20 22:10:40'),
(11, 'AP01004', 1, 'KIT Gejala Alam', 1, '2023-03-18 08:58:53'),
(12, 'AP02001', 4, 'Matematika Pemula', 1, '2023-03-18 09:01:34'),
(13, 'AP02002', 4, 'Matematika Pemula', 1, '2023-03-18 09:01:56'),
(14, 'AP02003', 4, 'MAPER Membuat Koordinat', 1, '2023-03-18 09:09:02'),
(15, 'AP02004', 4, 'MAPER Permainan Pecahan', 1, '2023-03-18 09:10:09'),
(16, 'AP02005', 4, 'MAPER Menghitung Massa', 1, '2023-03-18 09:10:33'),
(17, 'AP02006', 4, 'MAPER Membuat Koordinat', 1, '2023-03-18 09:11:09'),
(18, 'AP02007', 4, 'MAPER Permainan Pecahan', 1, '2023-03-18 09:11:39'),
(19, 'AP02008', 4, 'MAPER Menghitung Waktu &amp; Jarak ', 1, '2023-03-18 09:12:18'),
(20, 'AP02009', 4, 'MAPER Menghitung Massa', 1, '2023-03-18 09:12:55'),
(21, 'AP02010', 4, 'MAPER Menghitung Waktu &amp; Jarak', 1, '2023-03-18 09:13:36'),
(22, 'AP03001', 5, 'Alat Peraga Bahasa Inggris', 1, '2023-03-18 09:23:22'),
(23, 'AP03002', 5, 'Alat Peraga Bahasa Inggris', 1, '2023-03-18 09:23:39'),
(24, 'AP03003', 5, 'Alat Peraga Bahasa Indonesia', 1, '2023-03-18 09:24:14'),
(25, 'AP03004', 5, 'Alat Peraga Bahasa Indonesia', 1, '2023-03-20 22:38:50'),
(26, 'AP01009', 1, 'Poster KIT Gejala Alam', 1, '2023-03-20 22:31:52'),
(27, 'AP01006', 1, 'Alat Peraga Simulasi Fase Bulan', 1, '2023-03-21 07:24:36'),
(30, 'AP01010', 1, 'Poster KIT Gejala Alam', 1, '2023-03-21 07:32:48'),
(31, 'AP01011', 1, 'Poster KIT Gejala Alam', 1, '2023-03-21 07:33:15'),
(32, 'AP01012', 1, 'Poster KIT Gejala Alam', 1, '2023-03-21 07:33:42'),
(33, 'AP03005', 5, 'test', 1, '2023-03-21 16:01:36');
...
INSERT INTO `tbl_kategori_alat` (`id_kategori`, `kode_kategori`, `nama_kategori`) VALUES
(1, '01', 'IPAS'),
(4, '02', 'Matematika'),
(5, '03', 'Bahasa');
...
INSERT INTO `tbl_kehadiran` (`id_kehadiran`, `tgl_kehadiran`, `siswa_id`, `kelas`) VALUES
(5, '2023-03-19', '3,5,6,7,8,9', '5'),
(6, '2023-03-19', '10', '2'),
(10, '2023-03-19', '11', '4'),
(11, '2023-03-18', '11', '4'),
(12, '2023-03-21', '17,15,14,13,18', ''),
(13, '2023-03-20', '18', '');
...
--
-- Struktur dari tabel `tbl_pinjam_alat`
--
...
--
-- Dumping data untuk tabel `tbl_pinjam_alat`
--

INSERT INTO `tbl_pinjam_alat` (`id_pinjam`, `pinjam_id`, `anggota_id`, `kode`, `status`, `tgl_pinjam`, `lama_pinjam`, `tgl_balik`, `tgl_kembali`) VALUES
(8, 'PJ001', '0001', 'AP03005', 'Di Kembalikan', '2023-03-21', 1, '2023-03-22', '2023-03-21');
...
--
-- Indeks untuk tabel `tbl_pinjam_alat`
--
ALTER TABLE `tbl_pinjam_alat`
  ADD PRIMARY KEY (`id_pinjam`);
...
--
-- AUTO_INCREMENT untuk tabel `tbl_pinjam_alat`
--
ALTER TABLE `tbl_pinjam_alat`
