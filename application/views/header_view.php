...
<head>
  ...
  <title><?php echo $title_web; ?> | Sistem Informasi Perpustakaan Kampus Mengajar 5 </title>
  ...
  <!-- sweetalert -->
  <script src="<?php echo base_url(); ?>assets_style/assets/plugins/sweetalert/sweetalert2.all.js"></script>
  ...
  <script type="text/javascript" src="<?php echo base_url(); ?>assets_style/assets/plugins/plugins/chart.js/Chart.js"></script>
</head>
  ...
  <div class="wrapper">
    <header class="main-header">
      ...
      <a href="<?php echo base_url('index.php/dashboard'); ?>" class="logo">
        ...
        <span class="logo-mini"><b>KM5</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg">Perpus KM5</span>
      </a>
