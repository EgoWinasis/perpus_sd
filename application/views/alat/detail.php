...
<?php
	...
	$kat = $this->M_Admin->get_tableid_edit('tbl_kategori_alat','id_kategori',$idkat);
?>
...
<table id="example1" class="table table-bordered table-striped">
	...
	<?php 
	$no = 1;
	$alatid = $alat->kode_alat;
	$pin = $this->db->query("SELECT * FROM tbl_pinjam WHERE kode ='$alatid' AND status = 'Dipinjam'")->result_array();
	foreach($pin as $si)
	{
