                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" required name="penerbit" placeholder="Nama Penerbit">
                                    </div>
                                    <div class="form-group">
                                        <label>Tahun Buku</label>
                                        <input type="number" class="form-control" required min="1900" name="thn" placeholder="Tahun Buku : 2019">
                                    </div>
                                    <div class="form-group">
                                        <label>Jumlah Buku</label>
                                        <input type="number" class="form-control" min="1" required name="jml" value="1" readonly placeholder="Jumlah buku : 1">
                                    </div>
